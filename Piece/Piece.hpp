...
enum  Couleur{ CYAN , BLUE, ORANGE, YELLOW, GREEN, RED, GHOST, BLACK }; // Les couleurs de chaque pièce, GHOST est pour la pièce fantôme
//LES COULEURS SERVENT AUSSI POUR LES CASES VIDES DU TABLEAU
